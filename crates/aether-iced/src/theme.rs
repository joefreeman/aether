...
pub struct Palette {
    ...
    pub cursor_line_staged_deleted_bg: Color,
    pub cursor_line_staged_modified_bg: Color,
    pub cursor_line_deleted_bg: Color,
...
impl Palette {
    fn from_theme(t: &Theme) -> Palette {
        Palette {
            ...
            git_added_emph_bg: color(t.git_added_emph_bg),
            ...
            cursor_line_staged_deleted_bg: color(t.cursor_line_staged_deleted_bg),
            cursor_line_staged_modified_bg: color(t.cursor_line_staged_modified_bg),
            cursor_line_deleted_bg: color(t.cursor_line_deleted_bg),
